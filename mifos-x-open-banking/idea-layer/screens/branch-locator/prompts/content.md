...
content_hash: f99add499fc796eed82c93a338a0d6d52b41d9330ef6523c2cd5fa4d314c4a2a
...
# branch-locator — content state

> Auto-generated from screens/branch-locator/ui.yaml @ SHA 60b855423f6f8efc
...
6. **list** (#branch_list) — 1 items: "(item)"
7. **list_item** (#branch_row) — 1 items: "(item)"
8. **banner** (#branch_closure_banner)
9. **week_table** (#branch_opening_hours)
10. **contact_row** (#branch_contact) — 1 items: "(item)"
