...
content_hash: 5282fbede0eb45b72868dd5cdbbca98bf3b0c7ef7c617767c1a8201d07d7c81c
...
# kyc-review — content state

> Auto-generated from screens/kyc-review/ui.yaml @ SHA 5c5885c0243abae2
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Kyc-review screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
