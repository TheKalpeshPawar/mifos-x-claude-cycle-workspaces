...
> Auto-generated from screens/customer-detail/ui.yaml @ SHA b4d28f097f569f46
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **loading** state of the Customer-detail screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 11 - Input** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 12 - Input** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 13 - Input** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 14 - Input** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 15 - Input** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 16 - Box** (shimmer placeholder, layout-matching): rendered per design system component spec.
...
**Component 23 - Link** (shimmer placeholder, layout-matching): rendered per design system component spec.
...
**Component 27 - Box** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 28 - Text** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 29 - Link** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 30 - Box** (shimmer placeholder, layout-matching): rendered per design system component spec.
...
**Component 34 - Spacer** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 35 - Button** (shimmer placeholder, layout-matching): rendered per design system component spec.

**Component 36 - Button** (shimmer placeholder, layout-matching): rendered per design system component spec.
