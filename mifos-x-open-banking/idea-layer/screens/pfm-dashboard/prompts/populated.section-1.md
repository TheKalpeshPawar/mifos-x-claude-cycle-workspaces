# pfm-dashboard — populated state — section 1/2
...
Design the **populated** state of the Pfm Dashboard screen for **Mifos X Open Banking**, a open banking KMP super-app delivering consumer retail banking and field officer agent banking. Section 1 of 2.
