# pfm-dashboard — error state — section 2/2

> Composition fragment. Compose into the parent (error.md). DESIGN.md is the contract.
...
Design the **error** state of the Pfm Dashboard screen for **Mifos X Open Banking**, a open banking KMP super-app delivering consumer retail banking and field officer agent banking. Section 2 of 2.
