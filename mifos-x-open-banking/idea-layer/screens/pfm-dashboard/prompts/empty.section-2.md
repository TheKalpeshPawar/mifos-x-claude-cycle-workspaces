# pfm-dashboard — empty state — section 2/2
...
Design the **empty** state of the Pfm Dashboard screen for **Mifos X Open Banking**, a open banking KMP super-app delivering consumer retail banking and field officer agent banking. Section 2 of 2.
