...
content_hash: 0b5d579279ba16022eed4dfc6bba8b9e0af09e4fe5653d3e4f31f4a3e3c8c605
...
> Auto-generated from screens/account-detail/ui.yaml @ SHA 5d7888e020219fa6
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Account-detail screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 4 - Divider** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 11 - Spacer** (full width minus 32dp insets): rendered per design system component spec.
