...
content_hash: 13ea187c4eabe5e69b6e0513da8e15cf72b020d93f3358e17eb332c4772aa7dc
...
feature: login
state: oauth_exchanging
state_visibility: oauth_exchanging
...
# login — oauth_exchanging state

> Auto-generated from screens/login/ui.yaml @ SHA a34dcf8a3d34dcde
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **oauth_exchanging** state of the Login screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 1 - Stack** (full width minus 32dp insets): rendered per design system component spec. form archetype.
...
**Component 5 - Input** (full width minus 32dp insets): rendered per design system component spec.

**Component 6 - Input** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 10 - Card** (full width minus 32dp insets): rendered per design system component spec.

**Component 11 - Icon** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 15 - Divider** (full width minus 32dp insets): rendered per design system component spec.

**Component 16 - Text** (full width minus 32dp insets): rendered per design system component spec.

**Component 17 - Divider** (full width minus 32dp insets): rendered per design system component spec.

**Component 18 - Button** (full width minus 32dp insets): rendered per design system component spec.

**Component 19 - Text** (full width minus 32dp insets): rendered per design system component spec.

**Component 20 - Divider** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 24 - Loading Indicator** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 27 - Loading Indicator** (full width minus 32dp insets): rendered per design system component spec.
