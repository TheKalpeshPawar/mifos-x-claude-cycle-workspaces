...
content_hash: login-content-2026-06-02
...
Design the content state of the Login screen for **Mifos Open Banking**, a Kotlin Multiplatform open-banking super-app for consumer retail banking and field officer agent banking. This is the canonical loaded state, identical to idle with every field interactive.
