...
content_hash: ddb630ad24ea95e23a3fd07930372a8864c7b30dd08ea0e9383684a3103a2249
...
> Auto-generated from screens/login/ui.yaml @ SHA 74944677c7616a12
...
7. **section_header** (#permissions_header) — 8 items: "Account details", "Balances", "Transaction history", "Beneficiaries", "Standing orders", "Direct debits", "Scheduled payments", "Statements" …and 2 more similar cards
8. **list** (#permissions_list) — "permissions_list"
   - **list_item** (#permission_row) — 8 items: "Account details", "Balances", "Transaction history", "Beneficiaries", "Standing orders", "Direct debits", "Scheduled payments", "Statements" …and 2 more similar cards
...
- demo-data.requested_permissions[0..7] (+2)
- demo-data.requested_permissions[0..7] (+2)
