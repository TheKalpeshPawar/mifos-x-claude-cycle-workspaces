...
content_hash: 9104ccdeade61aebcfbcc844a4c6e9552d89a4c45af4b28c3ceb9b0f03057d9a
...
# auth-callback — verifying state

> Auto-generated from screens/auth-callback/ui.yaml @ SHA 394a0e6dd6350aec
...
- Custom state "Verifying" — render per the composition below.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("verifying"). Do not blend multiple states into one mockup.
