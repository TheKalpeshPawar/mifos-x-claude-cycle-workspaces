...
content_hash: 0498e1c1a1682c27118403b194031b5cf21e51869810e5b777c496bd204b253b
...
# send-money-confirm — empty state

> Auto-generated from screens/send-money-confirm/ui.yaml @ SHA 585f23b89717bda0
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **empty** state of the Send-money-confirm screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 5 - Divider** (centered, generous vertical breathing room): rendered per design system component spec.
...
**Component 25 - Input** (centered, generous vertical breathing room): rendered per design system component spec.
