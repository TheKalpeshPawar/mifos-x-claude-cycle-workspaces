...
content_hash: 6e58f5f3cf6b95cb7acc2ff41b01ad28571a2e53c74fd26f21c908be446a7ae3
...
# send-money-confirm — success state

> Auto-generated from screens/send-money-confirm/ui.yaml @ SHA 270ebbd0c16942d8
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **success** state of the Send-money-confirm screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 1 - Text** (full width minus 32dp insets): rendered per design system component spec. success_state archetype.
...
**Component 5 - Divider** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 25 - Input** (full width minus 32dp insets): rendered per design system component spec.
