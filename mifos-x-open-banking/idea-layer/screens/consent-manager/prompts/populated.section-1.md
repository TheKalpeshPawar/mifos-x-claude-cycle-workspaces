# consent-manager — populated state — section 1/1

> Composition fragment. Compose into the parent (populated.md). DESIGN.md is the contract.
...
4. **stack** (#moneymanager_header_row) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
5. **image** (#moneymanager_logo) — label: "MoneyManager Pro logo", content: "app_logo_moneymanager"
6. **stack** (#moneymanager_info) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
...
10. **stack** (#moneymanager_scopes_row) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
...
16. **stack** (#taxhelper_header_row) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
17. **image** (#taxhelper_logo) — label: "TaxHelper logo", content: "app_logo_taxhelper"
18. **stack** (#taxhelper_info) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
...
22. **stack** (#taxhelper_scopes_row) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
...
27. **stack** (#budgetwise_header_row) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
28. **image** (#budgetwise_logo) — label: "BudgetWise logo", content: "app_logo_budgetwise"
29. **stack** (#budgetwise_info) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
...
33. **stack** (#budgetwise_scopes_row) — 2 items: "consent-001-ke-safaricom-data", "consent-002-ke-equity-open" …and 2 more similar cards
...
39. **stack** (#revoke_dialog_actions) — 1 items: "consent-003-ke-ncba-loop"
