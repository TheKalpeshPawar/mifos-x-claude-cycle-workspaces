...
content_hash: 4fd93d5b6c89730cb6ad325f0951c8ed4ca2b4d8d7ae5456f153f9ecf5ee9a9e
...
> Auto-generated from screens/consent-manager/ui.yaml @ SHA 7e1250207e2e1b5b
...
## Composition (top → bottom) — split into 1 sections
1. **section-1** — see screens/consent-manager/prompts/populated.section-1.md

## Content source manifest
- demo-data.consents[0..1] (+2)
- demo-data.consents[0..1] (+2)
- demo-data.consents[0..1] (+2)
- demo-data.consents[0..1] (+2)
- demo-data.consents[0..1] (+2)
...
- demo-data.consents[0..1] (+2)
- demo-data.consents[0..1] (+2)
- demo-data.revoke_responses[0..0]
