...
content_hash: e74ae6e27a9800d67fd55d599162ef22983ceebfc56ee3af00648c9a62a93224
...
# corporate-onboarding — step_1 state

> Auto-generated from screens/corporate-onboarding/ui.yaml @ SHA 36786a0b368a33b9
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the step_1 state of the Corporate Enrollment screen for **Mifos X Open Banking**, a open banking KMP super-app for consumer retail banking and field officer agent banking powered by Open Bank Project API v7.
...
**Component 17 - Button** (full width minus 32dp insets): rendered per design system component spec.
