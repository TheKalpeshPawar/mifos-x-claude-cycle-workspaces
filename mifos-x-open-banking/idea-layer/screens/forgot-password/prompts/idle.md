...
content_hash: 5631c41ecf25b7ffa58b2a956565e5cbe201131265ddd9841df658de29c72d50
...
# forgot-password — idle state

> Auto-generated from screens/forgot-password/ui.yaml @ SHA fd83b370d4400d98
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **idle** state of the Forgot-password screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
