...
content_hash: 76416554c79e9b791ab09fbfc34ce15ff9d24199188f95ce955077550675a57b
...
# forgot-password — empty state

> Auto-generated from screens/forgot-password/ui.yaml @ SHA 2828622d976d096f
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **empty** state of the Forgot-password screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 7 - Banner** (centered, generous vertical breathing room): rendered per design system component spec.

**Component 8 - Stack** (centered, generous vertical breathing room): rendered per design system component spec.

**Component 9 - Icon** (centered, generous vertical breathing room): rendered per design system component spec.
...
**Component 13 - Link** (centered, generous vertical breathing room): rendered per design system component spec.
