...
content_hash: 1f7bfc8269ba1368fa3483395347c5eff2478989ba3d3a4889e2ad1e364fbff8
...
# forgot-password — content state

> Auto-generated from screens/forgot-password/ui.yaml @ SHA 7687645b3f1cedc2
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Forgot-password screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 7 - Banner** (full width minus 32dp insets): rendered per design system component spec.

**Component 8 - Stack** (full width minus 32dp insets): rendered per design system component spec.

**Component 9 - Icon** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 13 - Link** (full width minus 32dp insets): rendered per design system component spec.
