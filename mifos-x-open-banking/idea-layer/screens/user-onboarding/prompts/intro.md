...
- Custom state "Intro" — render per the composition below. This is the screen's initial state.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("intro"). Do not blend multiple states into one mockup.
