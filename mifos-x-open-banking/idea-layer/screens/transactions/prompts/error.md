...
content_hash: f1ed64b00af438db64453a508415d370d90299ae05cbab04453af0f6dbbabbd4
...
> Auto-generated from screens/transactions/ui.yaml @ SHA 7bc845423bdd8950
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **error** state of the Transactions screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 9 - Button** (centered, generous vertical breathing room): rendered per design system component spec.

**Component 10 - Spacer** (centered, generous vertical breathing room): rendered per design system component spec.
