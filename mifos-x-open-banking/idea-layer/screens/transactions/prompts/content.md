...
content_hash: a45e7fdc6d748f4b0339a028e3c979b75eee0f7e889ae66fc070b41ad021b3da
...
> Auto-generated from screens/transactions/ui.yaml @ SHA 83b66ca0dda12e9d
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Transactions screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 1 - Input** (full width minus 32dp insets): rendered per design system component spec. index_list archetype.
...
**Component 10 - Spacer** (full width minus 32dp insets): rendered per design system component spec.
