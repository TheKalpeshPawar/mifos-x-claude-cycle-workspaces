...
> Auto-generated from screens/privacy-policy/ui.yaml @ SHA d1b0afd1ea5c0f34
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Privacy-policy screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 2 - Banner** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 8 - Card** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 11 - Card** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 17 - Card** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 20 - Card** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 23 - Card** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 29 - Skeleton** (full width minus 32dp insets): rendered per design system component spec.

**Component 30 - Stack** (full width minus 32dp insets): rendered per design system component spec.

**Component 31 - Icon** (full width minus 32dp insets): rendered per design system component spec.

**Component 32 - Text** (full width minus 32dp insets): rendered per design system component spec.

**Component 33 - Button** (full width minus 32dp insets): rendered per design system component spec.
