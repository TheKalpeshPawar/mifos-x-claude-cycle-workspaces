...
content_hash: ff7a0d38a268eaf8dd9a13f5290dfff6227b97a8622fd440b4731a1d4c19ad71
...
# payment-authorize-handoff — preparing state

> Auto-generated from screens/payment-authorize-handoff/ui.yaml @ SHA 16f447d6b271ea40
...
- Custom state "Preparing" — render per the composition below. This is the screen's initial state.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("preparing"). Do not blend multiple states into one mockup.
