---
ui_yaml_sha: df3f7aca308bba179da97d4a24d7111b3f297ae3423b98ee18b8b17e2cd119af
...
> Auto-generated from screens/customer-profile/ui.yaml @ SHA 801b793c3663b275
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **loading** state of the Customer-profile screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 8 - Divider** (shimmer placeholder, layout-matching): rendered per design system component spec.
...
**Component 13 - Divider** (shimmer placeholder, layout-matching): rendered per design system component spec.
