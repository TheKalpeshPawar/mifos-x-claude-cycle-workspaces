...
> Auto-generated from screens/standing-orders/ui.yaml @ SHA 1aabf666b5b7a62d
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Standing-orders screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 1 - Stack** (full width minus 32dp insets): rendered per design system component spec. detail_screen archetype.
...
**Component 14 - Icon** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 20 - Icon** (full width minus 32dp insets): rendered per design system component spec.

**Component 21 - Icon** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 27 - Icon** (full width minus 32dp insets): rendered per design system component spec.

**Component 28 - Icon** (full width minus 32dp insets): rendered per design system component spec.

**Component 29 - Button** (full width minus 32dp insets): rendered per design system component spec.
