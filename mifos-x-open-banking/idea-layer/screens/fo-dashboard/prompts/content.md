...
> Auto-generated from screens/fo-dashboard/ui.yaml @ SHA 50d5476308d0a5b7
> Stitch DesignSystem: (pending DESIGN.md upload — run /idea-export-stitch sub-plan 02)
> DO NOT redeclare colors / fonts / spacing — they live in DESIGN.md.

↓↓↓ MOCKUP PROMPT

Design the **content** state of the Fo-dashboard screen for **mifos-x-open-banking**, a Open Banking KMP super-app - consumer retail banking + field officer agent banking powered by Open Bank Project API v7, built with Compose Multiplatform across Android, iOS, Desktop, and Web Material 3 balanced dark theme, 393×852dp (Pixel 5), Outfit font throughout.
...
**Component 2 - Icon** (full width minus 32dp insets): rendered per design system component spec.

**Component 3 - Icon** (full width minus 32dp insets): rendered per design system component spec.

**Component 4 - Text** (full width minus 32dp insets): rendered per design system component spec.

**Component 5 - Grid** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 19 - Box** (full width minus 32dp insets): rendered per design system component spec.

**Component 20 - Text** (full width minus 32dp insets): rendered per design system component spec.

**Component 21 - Button** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 24 - Button** (full width minus 32dp insets): rendered per design system component spec.

**Component 25 - Box** (full width minus 32dp insets): rendered per design system component spec.
...
**Component 29 - Box** (full width minus 32dp insets): rendered per design system component spec.
