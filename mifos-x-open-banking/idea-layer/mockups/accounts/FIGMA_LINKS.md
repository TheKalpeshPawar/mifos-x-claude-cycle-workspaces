...
| Generated | 2026-05-29T17:13:06.895Z |
| Success | 0/4 states |
...
|-------|-----------|--------|-----|------|--------|
| loading | — | 01-accounts-loading | PNG ❌ | HTML ❌ | ❌ StitchError: Tool Call Failed [generate_screen_from_text]: Resource has been exhausted (e.g. check quota). |
...
| empty | — | 03-accounts-empty | PNG ❌ | HTML ❌ | ❌ StitchError: Tool Call Failed [generate_screen_from_text]: Resource has been exhausted (e.g. check quota). |
