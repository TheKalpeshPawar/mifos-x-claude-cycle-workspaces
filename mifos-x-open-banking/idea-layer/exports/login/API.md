...
**Auth:** None
**Trigger:** App startup (once, cached)
...
**Trigger:** `onOAuthLoginClicked()` — opens system browser
...
| code_challenge        | String | {pkce_code_challenge} (SHA-256 of verifier)    |
...
**Auth:** None
**Trigger:** `onOAuthCallback(code, state)` — code exchange
