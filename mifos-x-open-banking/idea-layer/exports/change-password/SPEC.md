...
| ID              | Name              | Route            | Layout | Scroll   | ViewModel               | Archetype |
|-----------------|-------------------|------------------|--------|----------|-------------------------|-----------|
| change-password | Change Password   | /change-password | Column | Vertical | ChangePasswordViewModel | form      |

**States handled:** loading, idle, submitting, success, error, content, empty
...
_Generated by /idea export | 2026-06-02 (updated: archetype form + states_handled added to screens[])_
